...
export default function DatabaseMonitor() {
  ...
  return (
    <main className="relative flex min-h-full flex-col bg-[linear-gradient(180deg,#FFFFFF_0%,#E8EDF9_45%,#CAD6F4_100%)] px-5 pb-5 pt-6 sm:px-6 lg:px-8 xl:px-10 2xl:px-14">
      <TopBar />
