...
export default function Pods() {
  ...
  return (
    <main className="relative flex min-h-full flex-col bg-[#F8FAFC] px-7 py-5 text-[#243654]">
      <TopBar />
      ...
      {data && (
        <section className="mt-5 grid grid-cols-1 gap-4 xl:grid-cols-[1.4fr_0.6fr]">
