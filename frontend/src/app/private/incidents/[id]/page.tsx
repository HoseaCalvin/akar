...
export default function IncidentTimeline({
  ...
  return (
    <main className="relative min-h-screen bg-[linear-gradient(180deg,#FFFFFF_0%,#E8EDF9_45%,#CAD6F4_100%)] px-5 pb-10 pt-5 text-[#17294D] sm:px-7 lg:px-10 xl:px-14 2xl:px-20">
      <TopBar />
